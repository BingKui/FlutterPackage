...
///
/// Built on 2023-03-02 at 11:27 UTC
...
class _StringsHomePageEn {
	...
	// Translations
	String get tip => 'You have pushed the button this many times:';
...
class _StringsZhCn implements _StringsEn {
	...
	// Translations
	@override late final _StringsHomePageZhCn homePage = _StringsHomePageZhCn._(_root);
}

// Path: homePage
class _StringsHomePageZhCn implements _StringsHomePageEn {
	_StringsHomePageZhCn._(this._root);

	@override final _StringsZhCn _root; // ignore: unused_field

	// Translations
	@override String get tip => '你点击按钮的次数:';
	@override String get tooltip => '增加';
}
...
extension on _StringsEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'homePage.tip': return 'You have pushed the button this many times:';
			case 'homePage.tooltip': return 'Increment';
			default: return null;
		}
	}
}
...
extension on _StringsZhCn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'homePage.tip': return '你点击按钮的次数:';
			case 'homePage.tooltip': return '增加';
			default: return null;
		}
	}
}
